...
<?php
$sql="SELECT * FROM korpe WHERE isporuka='1' AND naplaceno='1' ";
...
<h1 style="font-family:geomanist; letter-spacing:1px; padding:10px; margin:10px 20px 20px 20px; text-align:center; border-bottom:solid 1px #ddd;">PAID</h1>
<?php for($x=1; $x<21; $x++) { 
if($red["jelo".$x]==0){}
else{
$idjelo=$red["jelo".$x];
